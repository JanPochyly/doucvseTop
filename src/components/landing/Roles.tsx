  ...
  return (
    <section className="w-full px-4 md:px-8 lg:px-16 py-12 flex flex-col items-center">
      <p className="text-sm md:text-base font-semibold text-left self-start mb-2">
        <span className="bg-gradient-to-r from-[#0072FA] via-[#1D0A42] to-[#FF0049] bg-clip-text text-transparent">Nemůžeš si vybrat?</span>
      </p>
        ...
        <div className="flex flex-col justify-between border-2 border-[#0072FA] rounded-3xl p-6 w-full lg:w-1/2 bg-white shadow-md">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex-1">
              ...
              <ul className="space-y-4">
                <li className="flex items-center gap-3">
                  <Image src="/img/landing/CheckBoxBlue.svg" alt="check" width={28} height={28} />
            ...
            <div className="flex-shrink-0">
              <Image src="/img/landing/StudentBlue.svg" alt="Student" width={100} height={100} />
            </div>
          </div>
        ...
        <div className="flex flex-col justify-between border-2 border-[#FF0049] rounded-3xl p-6 w-full lg:w-1/2 bg-white shadow-md">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex-1">
              ...
              <ul className="space-y-4">
                <li className="flex items-center gap-3">
                  <Image src="/img/landing/CheckBoxRed.svg" alt="check" width={28} height={28} />
            ...
            <div className="flex-shrink-0">
              <Image src="/img/landing/E-LearningRed.svg" alt="Teacher" width={100} height={100} />
            </div>
          </div>
